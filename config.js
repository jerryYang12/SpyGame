...
[
{ text: "布丁貓 Pudding Cat", img: "https://jerryyang12.github.io/SpyGame/pic/cat.jpg" },
{ text: "熊貓珍奶 Panda Boba", img: "https://jerryyang12.github.io/SpyGame/pic/panda.jpg" }
],
[
...
alert2: "Spies can't exceed players",
missingName: i => `Please enter name for Player ${i}`,
flip: "Flip in turn!",
execute: "Time to execute!",
spy: "✅ Is the spy🕵️!",
notSpy: "❌ Not the spy.",
placeholderCount: "Players",
spyCountPlaceholder: "Spies (Default 1)",
flipMe: "Tap to flip",
rule: "Rules for reference only: Find all spies, civilians win. Reach miss kills, spies win.",
colPlayer: "Players",
colSpy: "Spies",
colMissKill: "Miss Kills"
}
};